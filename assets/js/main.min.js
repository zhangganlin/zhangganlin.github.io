...
function limitNewsHeight(containerId) {
  ...
  const extraPadding = parseInt(container.dataset.padding) || 20;

  if (items.length === 0) return;

  // Compute total height of first `showCount` items including margins
  let height = 0;
  ...
  container.style.maxHeight = (height + extraPadding) + 'px';
}

// Call on page load
limitNewsHeight('news-container');
